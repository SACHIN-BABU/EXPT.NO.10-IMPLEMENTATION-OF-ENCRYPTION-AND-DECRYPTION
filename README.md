...
{ 
pt = m[i]; 
pt = pt - 96; // assuming lowercase letters 
k = 1; 
for (j = 0; j < key; j++) 
{ 
k = k * pt; 
...
# OUTPUT:
 ...
 <img width="1526" height="805" alt="Screenshot 2025-10-28 102735" src="https://github.com/user-attachments/assets/197c73be-2736-46e2-a4af-b435e46d96a6" />
